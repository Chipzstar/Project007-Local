...
export class ExpandableFabMenu extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            upOffsetY: new Animated.Value(-50),
            leftOffsetX: new Animated.Value(-50),
    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                {(this.state.open && this.props.menuIcons[4] !== null && this.props.menuIcons[4] !== undefined) ?
                    <Animated.View style={{
                        opacity: this.state.fadeIn,
                        ...
                        <ImageBackground style={{
                            ...
                            <TouchableOpacity
                                onPress={() => this.props.menuItemClicked(4)}
                                style={styles.mediumButton}>
                                {this.props.menuIcons[4]}
                            </TouchableOpacity>
                        </ImageBackground>
                    </Animated.View> :
                    <View style={{
