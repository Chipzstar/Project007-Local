...
import img from "../../../assets/images/drawable-xxxhdpi/db_11.png";
import styles from "./styles";

export default class DB11Tile extends Component {
    constructor(props) {
        super(props);
        this.state = {
            loading: true,
    ...
    async getAndLoadFirebaseUrl() {
        if (this.state.mounted) {
            const ref = await firebase.storage().ref('ModelScreenTiles/db_11.png');
